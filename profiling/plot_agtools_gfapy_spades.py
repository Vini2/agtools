...
plt.grid(True)
plt.legend()
plt.savefig("plots/runtime_spades_agtools_vs_gfapy.pdf", dpi=600, bbox_inches="tight")
plt.show()
...
plt.grid(True)
plt.legend()
plt.savefig("plots/memory_spades_agtools_vs_gfapy.pdf", dpi=600, bbox_inches="tight")
plt.show()
