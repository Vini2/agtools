...
def profile_files(folder_paths, runs=10):
    """Profile megahit.get_contig_graph on each folder multiple times."""
    results = []
    ...
    for folder_path in folder_paths:
        ...
        for _ in range(runs):
            res = profile_call(megahit.get_contig_graph, graph_file, contigs_file)
...
def main():
    ...
    folders = [
        "data/MEGAHIT/ERR2752163",
        "data/MEGAHIT/ERR2752147",
        "data/MEGAHIT/ERR2752151",
        "data/MEGAHIT/ERR2752146",
        "data/MEGAHIT/ERR2752150",
        "data/MEGAHIT/ERR2752145",
        "data/MEGAHIT/ERR2752149",
        "data/MEGAHIT/ERR2752153",
    ...
    # Save results
    df.to_csv("data/megahit_cprofile_res.csv", index=False)

    # Read the profiling results from CSV file
    df_results = pd.read_csv("data/megahit_cprofile_res.csv")
    ...
    plt.title("Running time vs number of GFA tags for MEGAHIT contig graph")
    plt.grid(True)
