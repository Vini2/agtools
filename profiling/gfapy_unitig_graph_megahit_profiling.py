...
def main():
    ...
    graph_files = [
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752163/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752147/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752151/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752146/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752150/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752145/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752149/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752153/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752144/megahit_output/converted_graph.gfa",
        "/scratch/user/mall0133/Tara_Oceans_data/assemblies/ERR2752143/megahit_output/converted_graph.gfa",
    ]
    
    df = profile_files(graph_files, runs=10)

    # Save results
    df.to_csv("gfapy_unitig_graph_megahit_profiling_res.csv", index=False)
