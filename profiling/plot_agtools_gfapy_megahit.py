...
plt.title("Running time - loading MEGAHIT converted GFA")
plt.gca().xaxis.set_major_formatter(FuncFormatter(lambda v, _: f"{v:.1f}"))
plt.grid(True)
plt.legend()
plt.savefig("plots/runtime_megahit_agtools_vs_gfapy.pdf", dpi=600, bbox_inches="tight")
plt.show()
...
plt.title("Memory usage - loading MEGAHIT converted GFA")
plt.gca().xaxis.set_major_formatter(FuncFormatter(lambda v, _: f"{v:.1f}"))
plt.grid(True)
plt.legend()
plt.savefig("plots/memory_megahit_agtools_vs_gfapy.pdf", dpi=600, bbox_inches="tight")
plt.show()
