...
*agtools* provides a command-line interface for manipulating assembly graphs, as well as a Python package interface for exploring assembly graphs in your own software. You can refer to the following resources to get an overview of the capabilities of *agtools*.
...
If you have a contig-level assembly graph from an assembler that is not listed above and has assembler-specific nuances, please submit a feature request via [agtools Issues](https://github.com/Vini2/agtools/issues).
...
If you visualise this graph using [Bandage](https://rrwick.github.io/Bandage/), it will appear as follows.
